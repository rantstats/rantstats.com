...
const hideNotification = (event) => {
    ...
    const rootNotificationParagraph = closeNotification.parentElement;
...
const ecInsertHtml = () => {
    ...
    const closeNotifications = document.getElementsByClassName('close-notification');
